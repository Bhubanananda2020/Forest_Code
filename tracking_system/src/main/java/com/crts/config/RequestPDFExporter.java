...
public class RequestPDFExporter {
	...
	public RequestPDFExporter(List<StatusEntityview> listRequests) {
	...
	private void writeTableHeader(PdfPTable table) {
		...
		table.addCell(cell);
		  ...
		  cell.setPhrase(new Phrase("reqassignto", font)); 
		  table.addCell(cell);
	...
	private void writeTableData(PdfPTable table) {
		for (StatusEntityview status : listRequests) {
			...
			//table.addCell(String.valueOf(status.getReqassignto()));
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph p = new Paragraph("List of Raise Requests", font);
