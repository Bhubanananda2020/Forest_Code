...
public class AssignRequestPDFExporter {

	private List<StatusEntityview> listRequests;

	public AssignRequestPDFExporter(List<StatusEntityview> listRequests) {
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph p = new Paragraph("List of Assign Requests", font);
